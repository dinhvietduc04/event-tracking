...
internal sealed class PostgresTestDatabase : IAsyncDisposable
{
    ...
    public WebApplicationFactory<Program> App(string profile = "Distributed", bool worker = false, bool seed = true,
        Dictionary<string, string?>? settings = null) => new WebApplicationFactory<Program>().WithWebHostBuilder(builder =>
    {
        ...
        builder.UseSetting("Storage:WorkerEnabled", worker.ToString());
