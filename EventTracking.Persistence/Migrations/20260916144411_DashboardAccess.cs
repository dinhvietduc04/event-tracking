...
namespace EventTracking.Persistence.Migrations
{
    ...
    public partial class DashboardAccess : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "project_memberships");

            migrationBuilder.DropTable(name: "dashboard_users");

            migrationBuilder.DropColumn(name: "name", table: "projects");
        }
    }
}
