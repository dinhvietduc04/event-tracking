...
namespace EventTracking.Persistence.Migrations
{
    ...
    public partial class InitialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    anonymous_id = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: true
                    ),
            ...
            migrationBuilder
                .CreateIndex(name: "IX_events_properties", table: "events", column: "properties")
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "storage_state");

            migrationBuilder.DropTable(name: "event_identity");
