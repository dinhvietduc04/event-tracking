...
$dashboardPassword = [Convert]::ToHexString([Security.Cryptography.RandomNumberGenerator]::GetBytes(16))
$lines += @('DASHBOARD_USERNAME=demo', "DASHBOARD_PASSWORD=$dashboardPassword")
$keys = @{}
...
Write-Host 'Dashboard: /dashboard/; use DASHBOARD_USERNAME and DASHBOARD_PASSWORD from your private .env.'
